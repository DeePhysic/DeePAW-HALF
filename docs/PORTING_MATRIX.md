...
| Analytic forces | not present in HAPPY | `half_energy.F90`, `half_local_forces.F90`, `half_forces.F90`, `half_uspp.F90`, `half_potcar_interp.F90`, `half_kpoints.F90` | implemented: Ewald, local, NLCC/`FORCOR`, generalized PAW projector `(D-epsilon Q)`, POTCAR augmentation density, augmentation `dD/dR`, full frozen-density Hartree+XC Harris response, and spglib observable-space expansion from irreducible k points; Si 216-point and 16-point-expanded forces agree within `1.1e-7 eV/Angstrom`, with 8.01x wall-time speedup |
