...
if(HALF_ENABLE_MPI)
  ...
  if(MPI_Fortran_FOUND)
    set(HALF_HAVE_MPI TRUE)
    message(STATUS "HALF MPI k-point distribution: ${MPI_Fortran_COMPILER}")
  else()
    set(HALF_HAVE_MPI FALSE)
    message(STATUS "HALF MPI disabled: no MPI Fortran implementation was found")
  endif()
else()
  set(HALF_HAVE_MPI FALSE)
  message(STATUS "HALF MPI disabled by HALF_ENABLE_MPI=OFF")
endif()
