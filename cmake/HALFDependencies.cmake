...
if(HALF_ENABLE_ESCN_API)
  find_package(CURL QUIET)
  if(CURL_FOUND)
    set(HALF_HAVE_CURL TRUE)
    set(HALF_HAVE_ESCN_API TRUE)
    set(HALF_HAVE_ESCN_SOCKET FALSE)
    message(STATUS "HALF DeePAW-eSCN API client: ${CURL_VERSION_STRING}")
  elseif(UNIX)
    set(HALF_HAVE_CURL FALSE)
    set(HALF_HAVE_ESCN_API TRUE)
    set(HALF_HAVE_ESCN_SOCKET TRUE)
    message(STATUS "HALF DeePAW-eSCN API client: built-in HTTP transport")
  else()
    set(HALF_HAVE_CURL FALSE)
    set(HALF_HAVE_ESCN_API FALSE)
    set(HALF_HAVE_ESCN_SOCKET FALSE)
    message(STATUS "HALF DeePAW-eSCN API client disabled: libcurl was not found")
  endif()
else()
  set(HALF_HAVE_CURL FALSE)
  set(HALF_HAVE_ESCN_API FALSE)
  set(HALF_HAVE_ESCN_SOCKET FALSE)
  message(STATUS "HALF DeePAW-eSCN API client disabled by HALF_ENABLE_ESCN_API=OFF")
endif()
