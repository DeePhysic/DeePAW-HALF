...
density remains frozen; the Harris response contains the Hartree plus XC-kernel
field generated by the output-minus-input density and contracts it with the
moving POTCAR `PSPRHO`. Spherical atomic PAW double counting is rebuilt
